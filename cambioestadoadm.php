...
<div class="fila">
  <div class="columna columna-m-12 columna-g-12" >
    ...
    <form class="w3-container w3-card-4 w3-middle" action="elegiraeronaveadm.php"   method="post">
      <input class="w3-input" type="text" style="width:90%" id="poliza"  name="poliza" required>
            <label>ID de la Póliza</label></p> <p>
<button type="submit" class="w3-button w3-indigo ">Seleccionar Póliza </button>
    </form>
    </div>
    </div>
