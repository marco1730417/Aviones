    ...
    <body>
      <div class="w3-container  w3-half">
        ...
        <header class="w3-container w3-teal ">
          <h1>INDIQUE LA AERONAVE PARA CAMBIAR EL ESTADO</h1>
        </header>
    <form class="w3-container w3-card-4 w3-middle" action="ver1.php"   method="post">
      <input class="w3-input" type="text" style="width:90%" id="aeronave"  name="aeronave" required>
            <label>ID de la aeronave</label></p> <p>
<button type="submit" class="w3-button w3-indigo ">Seleccionar Aeronave </button>
    </form>
    </div>
    </div>
    ...
    $conexion=conectarDB();
    $poliza= $_POST['poliza'];
    $ok= listarpolizas( $conexion, $poliza );
    ?>
        </form>
