...
<div class="fila">
  ...
  <label>El ID de su aeronave a buscar es <?php   echo $aeronave ; ?></label></p> <p>
    <label>El Desea consultar en el estado <?php   echo $estado ; ?></label></p> <p>

        <a href="reporteporaeronaveestado.php" class="w3-button w3-indigo">Ver Reporte</a>
    </form>
    </div>
    </div>
