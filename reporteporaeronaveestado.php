...
$aeronave=$_SESSION['aeronaves'];
$_SESSION["aeronaves"] = $aeronave;
...
(select (sum(dias))from estado where id_aeronave=".$aeronave." and nombre_estado='".$estado."' )as total_dias,
(select (sum(valor_total))from estado where id_aeronave=".$aeronave." and nombre_estado='".$estado."')as valor_total
from estado,aeronave
where estado.id_aeronave=aeronave.id_aeronave
and estado.nombre_estado='".$estado."'
...
$pdf->AddPage();
        ...
        $j=$j+1;
           ...
           $pdf->cell(0,8,'',0,1);
           $pdf->Text(15,$pdf->GetY(),'TOTAL DE DIAS');
           $pdf->Text(60,$pdf->GetY(),'VALOR TOTAL');


           $pdf->cell(0,5,'',0,1);
           $pdf->Text(15,$pdf->GetY(),$total);
           $pdf->Text(60,$pdf->GetY(),$totalto);
