...
<div class="w3-container  w3-half">
  <div class="w3-container  w3-margin-top">
    <header class="w3-container w3-teal ">
      <h1>INGRESAR AEROTÉCNICO</h1>
    </header>
  <form class="w3-container w3-card-4  w3-border-blue " action="db_insertarempleado.php"  method="post">
<p>
      <input class="w3-input" type="text" style="width:60%" id="nombre"  name="nombre" required>
      <label>Nombre del aerotécnico</label></p>
      <p>
            <input class="w3-input" type="text" style="width:60%" id="direccion"  name="direccion" required>
            <label>Dirección del aerotécnico</label></p>
...
<p>
              ...
              <p>
                    ...
                    <button type="submit" class="w3-button w3-blue">Ingresar Aerotécnico</button>
</form>
</div>
</div>
...
<div class="w3-container  w3-margin-top">
<header class="w3-container w3-teal ">
                    <h1>MÁS OPCIONES AEROTÉCNICO</h1>
                </header>
  <form class="w3-container w3-card-4 w3-middle"  action="db_eliminarempleado.php" method="post">

<p>
      <input class="w3-input" type="text" style="width:60%" id="empleado"  name="empleado" required>
      <label>Id Aerotécnico</label></p>
