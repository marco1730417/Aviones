...
<div class="fila">
  <div class="columna columna-m-12 columna-g-12" >
    ...
    <form class="w3-container w3-card-4 w3-middle" action="tablaaeronavesporpolizanormal.php"   method="post">

            <label>El ID de su aeronave es <?php   echo $aeronave ; ?></label></p> <p>
            <label>El ID de su poliza es es <?php   echo $poliza1 ; ?></label></p> <p>
            <button type="submit" class="w3-button w3-indigo ">Continuar</button>
    </form>
    </div>
    </div>
